...
export type ConfigMsgIn = { tag: "Ping" } | { tag: "GetAllApps" } | { tag: "GetGlobalConfig" } | { tag: "SetGlobalConfig", value: GlobalConfig } | { tag: "SetLayout", value: Layout } | { tag: "GetAllAppParams" } | { tag: "GetAppParams", value: { layout_id: u8 } } | { tag: "SetAppParams", value: { layout_id: u8, values: FixedLengthArray<Value | undefined, 17> } } | { tag: "FactoryReset" } | { tag: "GetVersion" }
export type ConfigMsgOut = { tag: "Pong" } | { tag: "BatchMsgStart", value: u64 } | { tag: "BatchMsgEnd" } | { tag: "GlobalConfig", value: GlobalConfig } | { tag: "Layout", value: Layout } | { tag: "AppConfig", value: [u8, u64, [u64, string, string, Color, AppIcon, Param[]]] } | { tag: "AppState", value: [u8, Value[]] } | { tag: "Version", value: { major: u8, minor: u8, patch: u8 } }
export type Curve = { tag: "Linear" } | { tag: "Logarithmic" } | { tag: "Exponential" }
export type GlobalConfig = { aux: FixedLengthArray<AuxJackMode, 3>, clock: ClockConfig, i2c_mode: I2cMode, led_brightness: u8, midi: MidiConfig, quantizer: QuantizerConfig, takeover_mode: latch.TakeoverMode }
