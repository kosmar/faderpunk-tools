...
export type ConfigMsgIn = { tag: "Ping" } | { tag: "GetAllApps" } | { tag: "GetGlobalConfig" } | { tag: "SetGlobalConfig", value: GlobalConfig } | { tag: "GetLayout" } | { tag: "SetLayout", value: Layout } | { tag: "GetAllAppParams" } | { tag: "GetAppParams", value: { layout_id: u8 } } | { tag: "SetAppParams", value: { layout_id: u8, values: FixedLengthArray<Value | undefined, 17> } } | { tag: "FactoryReset" } | { tag: "GetVersion" }
