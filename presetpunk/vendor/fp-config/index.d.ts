...
export type ConfigMsgIn = { tag: "Ping" } | { tag: "GetAllApps" } | { tag: "GetGlobalConfig" } | { tag: "SetGlobalConfig", value: GlobalConfig } | { tag: "GetLayout" } | { tag: "SetLayout", value: Layout } | { tag: "GetAllAppParams" } | { tag: "GetAppParams", value: { layout_id: u8 } } | { tag: "SetAppParams", value: { layout_id: u8, values: FixedLengthArray<Value | undefined, 16> } } | { tag: "FactoryReset" } | { tag: "GetVersion" } | { tag: "MeasureVoOct", value: { output_jack: u8, aux_input: u8, dac_counts: u16 } } | { tag: "SetVoOctOutput", value: { output_jack: u8, dac_counts: u16 } } | { tag: "ReleaseVoOctOutput", value: { output_jack: u8 } } | { tag: "HoldPerfMute" } | { tag: "ReleasePerfMute" }
